...
public:
	...
	void vyhra(NN& vyherce, NN& loser, int deleni, int& profit_vyherce, int& profit_loser);
...
void Ref::vyhra(NN& vyherce, NN& loser, int deleni, int& profit_vyherce, int& profit_loser) {
	...
	case 3:
		...
		else if (vyherce.vsazeno > pot / 2)
		{
			vyherce.mena += vyherce.vsazeno;
			loser.mena += (pot - vyherce.vsazeno);
		}
		else
		{
			loser.mena += loser.vsazeno;
			vyherce.mena += (pot - loser.vsazeno);
		}*/
		vyherce.mena += vyherce.vsazeno;
		loser.mena += loser.vsazeno;
		break;
